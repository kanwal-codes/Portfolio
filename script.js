...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (heroTitle) {
        ...
        // Create a simple fade-in animation instead of typing
...
document.addEventListener('DOMContentLoaded', () => {
    const interactiveElements = document.querySelectorAll('a, button, .skill-tag, .tech-tag');
...
document.addEventListener('keydown', (e) => {
    ...
    if (JSON.stringify(window.konamiCode) === JSON.stringify(konamiCode)) {
